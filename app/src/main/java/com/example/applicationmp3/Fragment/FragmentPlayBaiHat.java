...
import com.example.applicationmp3.Adapter.PlayNhacAdapter;
...
public class FragmentPlayBaiHat extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_play_bai_hat, container, false);
        recyclerView = view.findViewById(R.id.recyclerViewPlayBaiHat);
        playNhacAdapter = new PlayNhacAdapter(PlayMusicActivity.mangBaiHat, getActivity());
